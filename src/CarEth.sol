...
contract CarEth {
    ...
    function addRentals(
        ...
        require(msg.sender == owner, "Only the owner of the smart contract can put up rentals as of now");
    ...
    function addDatesBooked(uint256 id, string[] memory newBookings) public payable {
        ...
        require(msg.value == (rentals[id].pricePerday * 10000000000000000 wei * newBookings.length), "Please submit the asking price in order to complete the purchase");
